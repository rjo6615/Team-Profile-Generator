...
const generateEngineer = function(engineer) {
  return`
      ...
      <div class="card-body">
        ...
        <p class="card-text border border-muted shadow p-2 bg-body rounded">GitHub: <a href="https://www.github.com/${engineer.github}" target="_blank" rel="noopener noreferrer">${engineer.github}</a></p>
      </div>
    </div>
`
}
